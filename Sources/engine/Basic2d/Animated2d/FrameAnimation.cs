...
namespace TopDownShooter
{
    ...
    {
        public bool hasFired; // To be used in the next tutorial, was not specified
        public int frames, currentFrame, maxPasses, currentPass, fireFrame; // maxPasses still not really clear
        ...
        // Update (loop over the sprite sheets)
        public void Update()
        {
